"""
GovTech Nexus OpenAPI Router for TRADE_PERMIT_ISSUER_SERVICE
"""
...
router = APIRouter(prefix="/trade-permit-issuer", tags=["Trade Permit Issuer Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_trade_permit_issuer_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "trade_permit_issuer_service",
...
async def process_trade_permit_issuer_service_action(payload: Dict[str, Any]):
...
async def get_trade_permit_issuer_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "trade_permit_issuer_service",
