"""
GovTech Nexus OpenAPI Router for RECEIPT_PDF_GENERATOR_SERVICE
"""
...
router = APIRouter(prefix="/receipt-pdf-generator", tags=["Receipt Pdf Generator Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_receipt_pdf_generator_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "receipt_pdf_generator_service",
...
async def process_receipt_pdf_generator_service_action(payload: Dict[str, Any]):
...
async def get_receipt_pdf_generator_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "receipt_pdf_generator_service",
