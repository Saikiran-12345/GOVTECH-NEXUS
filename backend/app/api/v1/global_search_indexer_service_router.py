"""
GovTech Nexus OpenAPI Router for GLOBAL_SEARCH_INDEXER_SERVICE
"""
...
router = APIRouter(prefix="/global-search-indexer", tags=["Global Search Indexer Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_global_search_indexer_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "global_search_indexer_service",
...
async def process_global_search_indexer_service_action(payload: Dict[str, Any]):
...
async def get_global_search_indexer_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "global_search_indexer_service",
