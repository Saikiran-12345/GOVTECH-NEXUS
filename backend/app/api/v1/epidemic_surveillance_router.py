"""
GovTech Nexus OpenAPI Router for EPIDEMIC_SURVEILLANCE
"""
...
router = APIRouter(prefix="/epidemic-surveillance", tags=["Epidemic Surveillance"])

@router.get("/list", response_model=Dict[str, Any])
async def list_epidemic_surveillance_records(
...
async def process_epidemic_surveillance_action(payload: Dict[str, Any]):
...
async def get_epidemic_surveillance_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "epidemic_surveillance",
