"""
GovTech Nexus OpenAPI Router for DOCUMENT_VERIFICATION_FLOW_SERVICE
"""
...
router = APIRouter(prefix="/document-verification-flow", tags=["Document Verification Flow Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_document_verification_flow_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "document_verification_flow_service",
...
async def process_document_verification_flow_service_action(payload: Dict[str, Any]):
...
async def get_document_verification_flow_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "document_verification_flow_service",
