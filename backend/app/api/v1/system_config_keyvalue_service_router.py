"""
GovTech Nexus OpenAPI Router for SYSTEM_CONFIG_KEYVALUE_SERVICE
"""
...
router = APIRouter(prefix="/system-config-keyvalue", tags=["System Config Keyvalue Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_system_config_keyvalue_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "system_config_keyvalue_service",
...
async def process_system_config_keyvalue_service_action(payload: Dict[str, Any]):
...
async def get_system_config_keyvalue_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "system_config_keyvalue_service",
