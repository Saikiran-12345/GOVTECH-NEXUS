"""
GovTech Nexus OpenAPI Router for PARKING_PERMIT_MANAGER
"""
...
router = APIRouter(prefix="/parking-permit-manager", tags=["Parking Permit Manager"])

@router.get("/list", response_model=Dict[str, Any])
async def list_parking_permit_manager_records(
...
async def process_parking_permit_manager_action(payload: Dict[str, Any]):
...
async def get_parking_permit_manager_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "parking_permit_manager",
