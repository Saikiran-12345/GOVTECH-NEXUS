"""
GovTech Nexus OpenAPI Router for FEATURE_FLAG_MANAGER_SERVICE
"""
...
router = APIRouter(prefix="/feature-flag-manager", tags=["Feature Flag Manager Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_feature_flag_manager_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "feature_flag_manager_service",
...
async def process_feature_flag_manager_service_action(payload: Dict[str, Any]):
...
async def get_feature_flag_manager_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "feature_flag_manager_service",
