"""
GovTech Nexus OpenAPI Router for DOCUMENT_VIRUS_SCANNER_SERVICE
"""
...
router = APIRouter(prefix="/document-virus-scanner", tags=["Document Virus Scanner Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_document_virus_scanner_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "document_virus_scanner_service",
...
async def process_document_virus_scanner_service_action(payload: Dict[str, Any]):
...
async def get_document_virus_scanner_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "document_virus_scanner_service",
