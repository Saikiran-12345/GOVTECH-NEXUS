"""
GovTech Nexus OpenAPI Router for OFFICE_LOCATION_SERVICE
"""
...
router = APIRouter(prefix="/office-location", tags=["Office Location Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_office_location_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "office_location_service",
...
async def process_office_location_service_action(payload: Dict[str, Any]):
...
async def get_office_location_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "office_location_service",
