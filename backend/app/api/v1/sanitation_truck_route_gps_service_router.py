"""
GovTech Nexus OpenAPI Router for SANITATION_TRUCK_ROUTE_GPS_SERVICE
"""
...
router = APIRouter(prefix="/sanitation-truck-route-gps", tags=["Sanitation Truck Route Gps Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_sanitation_truck_route_gps_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "sanitation_truck_route_gps_service",
...
async def process_sanitation_truck_route_gps_service_action(payload: Dict[str, Any]):
...
async def get_sanitation_truck_route_gps_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "sanitation_truck_route_gps_service",
