"""
GovTech Nexus OpenAPI Router for HERITAGE_SITE_PROTECTION
"""
...
router = APIRouter(prefix="/heritage-site-protection", tags=["Heritage Site Protection"])

@router.get("/list", response_model=Dict[str, Any])
async def list_heritage_site_protection_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "heritage_site_protection",
...
async def process_heritage_site_protection_action(payload: Dict[str, Any]):
...
async def get_heritage_site_protection_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "heritage_site_protection",
