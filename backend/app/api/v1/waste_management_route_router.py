"""
GovTech Nexus OpenAPI Router for WASTE_MANAGEMENT_ROUTE
"""
...
router = APIRouter(prefix="/waste-management-route", tags=["Waste Management Route"])

@router.get("/list", response_model=Dict[str, Any])
async def list_waste_management_route_records(
...
async def process_waste_management_route_action(payload: Dict[str, Any]):
...
async def get_waste_management_route_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "waste_management_route",
