"""
GovTech Nexus OpenAPI Router for WELFARE_SCHEME_DISBURSER_SERVICE
"""
...
router = APIRouter(prefix="/welfare-scheme-disburser", tags=["Welfare Scheme Disburser Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_welfare_scheme_disburser_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "welfare_scheme_disburser_service",
...
async def process_welfare_scheme_disburser_service_action(payload: Dict[str, Any]):
...
async def get_welfare_scheme_disburser_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "welfare_scheme_disburser_service",
