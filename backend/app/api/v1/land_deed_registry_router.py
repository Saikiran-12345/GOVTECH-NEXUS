"""
GovTech Nexus OpenAPI Router for LAND_DEED_REGISTRY
"""
...
router = APIRouter(prefix="/land-deed-registry", tags=["Land Deed Registry"])

@router.get("/list", response_model=Dict[str, Any])
async def list_land_deed_registry_records(
...
async def process_land_deed_registry_action(payload: Dict[str, Any]):
...
async def get_land_deed_registry_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "land_deed_registry",
