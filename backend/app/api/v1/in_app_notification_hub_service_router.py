"""
GovTech Nexus OpenAPI Router for IN_APP_NOTIFICATION_HUB_SERVICE
"""
...
router = APIRouter(prefix="/in-app-notification-hub", tags=["In App Notification Hub Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_in_app_notification_hub_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "in_app_notification_hub_service",
...
async def process_in_app_notification_hub_service_action(payload: Dict[str, Any]):
...
async def get_in_app_notification_hub_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "in_app_notification_hub_service",
