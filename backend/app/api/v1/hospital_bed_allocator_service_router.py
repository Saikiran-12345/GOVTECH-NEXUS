"""
GovTech Nexus OpenAPI Router for HOSPITAL_BED_ALLOCATOR_SERVICE
"""
...
router = APIRouter(prefix="/hospital-bed-allocator", tags=["Hospital Bed Allocator Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_hospital_bed_allocator_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "hospital_bed_allocator_service",
...
async def process_hospital_bed_allocator_service_action(payload: Dict[str, Any]):
...
async def get_hospital_bed_allocator_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "hospital_bed_allocator_service",
