"""
GovTech Nexus OpenAPI Router for DIGITAL_CERTIFICATE_SIGNER_SERVICE
"""
...
router = APIRouter(prefix="/digital-certificate-signer", tags=["Digital Certificate Signer Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_digital_certificate_signer_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "digital_certificate_signer_service",
...
async def process_digital_certificate_signer_service_action(payload: Dict[str, Any]):
...
async def get_digital_certificate_signer_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "digital_certificate_signer_service",
