"""
GovTech Nexus OpenAPI Router for PUBLIC_PROCUREMENT_TENDER_SERVICE
"""
...
router = APIRouter(prefix="/public-procurement-tender", tags=["Public Procurement Tender Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_public_procurement_tender_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "public_procurement_tender_service",
...
async def process_public_procurement_tender_service_action(payload: Dict[str, Any]):
...
async def get_public_procurement_tender_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "public_procurement_tender_service",
