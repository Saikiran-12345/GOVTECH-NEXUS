"""
GovTech Nexus OpenAPI Router for FOOD_SAFETY_LICENSE
"""
...
router = APIRouter(prefix="/food-safety-license", tags=["Food Safety License"])

@router.get("/list", response_model=Dict[str, Any])
async def list_food_safety_license_records(
...
async def process_food_safety_license_action(payload: Dict[str, Any]):
...
async def get_food_safety_license_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "food_safety_license",
