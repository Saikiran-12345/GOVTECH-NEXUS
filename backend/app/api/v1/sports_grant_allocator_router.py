"""
GovTech Nexus OpenAPI Router for SPORTS_GRANT_ALLOCATOR
"""
...
router = APIRouter(prefix="/sports-grant-allocator", tags=["Sports Grant Allocator"])

@router.get("/list", response_model=Dict[str, Any])
async def list_sports_grant_allocator_records(
...
async def process_sports_grant_allocator_action(payload: Dict[str, Any]):
...
async def get_sports_grant_allocator_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "sports_grant_allocator",
