"""
GovTech Nexus OpenAPI Router for PUBLIC_HOUSING_ALLOTMENT
"""
...
router = APIRouter(prefix="/public-housing-allotment", tags=["Public Housing Allotment"])

@router.get("/list", response_model=Dict[str, Any])
async def list_public_housing_allotment_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "public_housing_allotment",
...
async def process_public_housing_allotment_action(payload: Dict[str, Any]):
...
async def get_public_housing_allotment_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "public_housing_allotment",
