"""
GovTech Nexus OpenAPI Router for VEHICLE_REGISTRATION_PORTAL_SERVICE
"""
...
router = APIRouter(prefix="/vehicle-registration-portal", tags=["Vehicle Registration Portal Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_vehicle_registration_portal_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "vehicle_registration_portal_service",
...
async def process_vehicle_registration_portal_service_action(payload: Dict[str, Any]):
...
async def get_vehicle_registration_portal_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "vehicle_registration_portal_service",
