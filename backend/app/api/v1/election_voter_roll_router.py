"""
GovTech Nexus OpenAPI Router for ELECTION_VOTER_ROLL
"""
...
router = APIRouter(prefix="/election-voter-roll", tags=["Election Voter Roll"])

@router.get("/list", response_model=Dict[str, Any])
async def list_election_voter_roll_records(
...
async def process_election_voter_roll_action(payload: Dict[str, Any]):
...
async def get_election_voter_roll_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "election_voter_roll",
