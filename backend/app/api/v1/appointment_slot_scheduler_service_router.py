"""
GovTech Nexus OpenAPI Router for APPOINTMENT_SLOT_SCHEDULER_SERVICE
"""
...
router = APIRouter(prefix="/appointment-slot-scheduler", tags=["Appointment Slot Scheduler Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_appointment_slot_scheduler_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "appointment_slot_scheduler_service",
...
async def process_appointment_slot_scheduler_service_action(payload: Dict[str, Any]):
...
async def get_appointment_slot_scheduler_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "appointment_slot_scheduler_service",
