"""
GovTech Nexus OpenAPI Router for URBAN_PARKING_SPACE_RESERVATION_SERVICE
"""
...
router = APIRouter(prefix="/urban-parking-space-reservation", tags=["Urban Parking Space Reservation Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_urban_parking_space_reservation_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "urban_parking_space_reservation_service",
...
async def process_urban_parking_space_reservation_service_action(payload: Dict[str, Any]):
...
async def get_urban_parking_space_reservation_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "urban_parking_space_reservation_service",
