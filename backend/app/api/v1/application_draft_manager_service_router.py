"""
GovTech Nexus OpenAPI Router for APPLICATION_DRAFT_MANAGER_SERVICE
"""
...
router = APIRouter(prefix="/application-draft-manager", tags=["Application Draft Manager Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_application_draft_manager_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "application_draft_manager_service",
...
async def process_application_draft_manager_service_action(payload: Dict[str, Any]):
...
async def get_application_draft_manager_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "application_draft_manager_service",
