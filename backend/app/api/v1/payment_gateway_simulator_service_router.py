"""
GovTech Nexus OpenAPI Router for PAYMENT_GATEWAY_SIMULATOR_SERVICE
"""
...
router = APIRouter(prefix="/payment-gateway-simulator", tags=["Payment Gateway Simulator Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_payment_gateway_simulator_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "payment_gateway_simulator_service",
...
async def process_payment_gateway_simulator_service_action(payload: Dict[str, Any]):
...
async def get_payment_gateway_simulator_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "payment_gateway_simulator_service",
