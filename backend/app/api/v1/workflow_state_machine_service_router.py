"""
GovTech Nexus OpenAPI Router for WORKFLOW_STATE_MACHINE_SERVICE
"""
...
router = APIRouter(prefix="/workflow-state-machine", tags=["Workflow State Machine Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_workflow_state_machine_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "workflow_state_machine_service",
...
async def process_workflow_state_machine_service_action(payload: Dict[str, Any]):
...
async def get_workflow_state_machine_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "workflow_state_machine_service",
