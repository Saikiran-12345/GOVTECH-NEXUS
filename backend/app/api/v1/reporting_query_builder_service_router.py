"""
GovTech Nexus OpenAPI Router for REPORTING_QUERY_BUILDER_SERVICE
"""
...
router = APIRouter(prefix="/reporting-query-builder", tags=["Reporting Query Builder Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_reporting_query_builder_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "reporting_query_builder_service",
...
async def process_reporting_query_builder_service_action(payload: Dict[str, Any]):
...
async def get_reporting_query_builder_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "reporting_query_builder_service",
