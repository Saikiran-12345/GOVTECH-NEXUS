"""
GovTech Nexus OpenAPI Router for ATHLETE_GRANT_SPONSOR_SERVICE
"""
...
router = APIRouter(prefix="/athlete-grant-sponsor", tags=["Athlete Grant Sponsor Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_athlete_grant_sponsor_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "athlete_grant_sponsor_service",
...
async def process_athlete_grant_sponsor_service_action(payload: Dict[str, Any]):
...
async def get_athlete_grant_sponsor_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "athlete_grant_sponsor_service",
