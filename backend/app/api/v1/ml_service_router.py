"""
GovTech Nexus OpenAPI Router for ML_SERVICE
"""
...
async def list_ml_service_records(
...
async def process_ml_service_action(payload: Dict[str, Any]):
...
async def get_ml_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "ml_service",
