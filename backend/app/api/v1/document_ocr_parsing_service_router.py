"""
GovTech Nexus OpenAPI Router for DOCUMENT_OCR_PARSING_SERVICE
"""
...
router = APIRouter(prefix="/document-ocr-parsing", tags=["Document Ocr Parsing Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_document_ocr_parsing_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "document_ocr_parsing_service",
...
async def process_document_ocr_parsing_service_action(payload: Dict[str, Any]):
...
async def get_document_ocr_parsing_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "document_ocr_parsing_service",
