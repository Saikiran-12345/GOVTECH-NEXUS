"""
GovTech Nexus OpenAPI Router for ARMS_LICENSE_REGISTRY
"""
...
router = APIRouter(prefix="/arms-license-registry", tags=["Arms License Registry"])

@router.get("/list", response_model=Dict[str, Any])
async def list_arms_license_registry_records(
...
async def process_arms_license_registry_action(payload: Dict[str, Any]):
...
async def get_arms_license_registry_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "arms_license_registry",
