"""
GovTech Nexus OpenAPI Router for SERVICE_DOCUMENT_RULES_SERVICE
"""
...
router = APIRouter(prefix="/service-document-rules", tags=["Service Document Rules Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_service_document_rules_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "service_document_rules_service",
...
async def process_service_document_rules_service_action(payload: Dict[str, Any]):
...
async def get_service_document_rules_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "service_document_rules_service",
