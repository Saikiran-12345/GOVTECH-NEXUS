"""
GovTech Nexus OpenAPI Router for SENIOR_PENSION_PAYOUT_SERVICE
"""
...
router = APIRouter(prefix="/senior-pension-payout", tags=["Senior Pension Payout Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_senior_pension_payout_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "senior_pension_payout_service",
...
async def process_senior_pension_payout_service_action(payload: Dict[str, Any]):
...
async def get_senior_pension_payout_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "senior_pension_payout_service",
