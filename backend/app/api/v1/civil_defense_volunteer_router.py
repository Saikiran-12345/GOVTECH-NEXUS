"""
GovTech Nexus OpenAPI Router for CIVIL_DEFENSE_VOLUNTEER
"""
...
router = APIRouter(prefix="/civil-defense-volunteer", tags=["Civil Defense Volunteer"])

@router.get("/list", response_model=Dict[str, Any])
async def list_civil_defense_volunteer_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "civil_defense_volunteer",
...
async def process_civil_defense_volunteer_action(payload: Dict[str, Any]):
...
async def get_civil_defense_volunteer_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "civil_defense_volunteer",
