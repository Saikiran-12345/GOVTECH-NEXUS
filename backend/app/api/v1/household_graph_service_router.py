"""
GovTech Nexus OpenAPI Router for HOUSEHOLD_GRAPH_SERVICE
"""
...
router = APIRouter(prefix="/household-graph", tags=["Household Graph Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_household_graph_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "household_graph_service",
...
async def process_household_graph_service_action(payload: Dict[str, Any]):
...
async def get_household_graph_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "household_graph_service",
