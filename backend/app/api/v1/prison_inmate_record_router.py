"""
GovTech Nexus OpenAPI Router for PRISON_INMATE_RECORD
"""
...
router = APIRouter(prefix="/prison-inmate-record", tags=["Prison Inmate Record"])

@router.get("/list", response_model=Dict[str, Any])
async def list_prison_inmate_record_records(
...
async def process_prison_inmate_record_action(payload: Dict[str, Any]):
...
async def get_prison_inmate_record_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "prison_inmate_record",
