"""
GovTech Nexus OpenAPI Router for COOPERATIVE_SOCIETY_REG
"""
...
router = APIRouter(prefix="/cooperative-society-reg", tags=["Cooperative Society Reg"])

@router.get("/list", response_model=Dict[str, Any])
async def list_cooperative_society_reg_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "cooperative_society_reg",
...
async def process_cooperative_society_reg_action(payload: Dict[str, Any]):
...
async def get_cooperative_society_reg_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "cooperative_society_reg",
