"""
GovTech Nexus OpenAPI Router for PENSION_DISBURSEMENT
"""
...
router = APIRouter(prefix="/pension-disbursement", tags=["Pension Disbursement"])

@router.get("/list", response_model=Dict[str, Any])
async def list_pension_disbursement_records(
...
async def process_pension_disbursement_action(payload: Dict[str, Any]):
...
async def get_pension_disbursement_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "pension_disbursement",
