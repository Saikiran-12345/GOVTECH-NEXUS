"""
GovTech Nexus OpenAPI Router for FIELD_INSPECTION_CHECKLIST_SERVICE
"""
...
router = APIRouter(prefix="/field-inspection-checklist", tags=["Field Inspection Checklist Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_field_inspection_checklist_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "field_inspection_checklist_service",
...
async def process_field_inspection_checklist_service_action(payload: Dict[str, Any]):
...
async def get_field_inspection_checklist_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "field_inspection_checklist_service",
