"""
GovTech Nexus OpenAPI Router for EMPLOYEE_LEAVE_MANAGEMENT_SERVICE
"""
...
router = APIRouter(prefix="/employee-leave-management", tags=["Employee Leave Management Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_employee_leave_management_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "employee_leave_management_service",
...
async def process_employee_leave_management_service_action(payload: Dict[str, Any]):
...
async def get_employee_leave_management_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "employee_leave_management_service",
