"""
GovTech Nexus OpenAPI Router for DROUGHT_RELIEF_FUND
"""
...
router = APIRouter(prefix="/drought-relief-fund", tags=["Drought Relief Fund"])

@router.get("/list", response_model=Dict[str, Any])
async def list_drought_relief_fund_records(
...
async def process_drought_relief_fund_action(payload: Dict[str, Any]):
...
async def get_drought_relief_fund_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "drought_relief_fund",
