"""
GovTech Nexus OpenAPI Router for FOOD_HYGIENE_LICENSE_SERVICE
"""
...
router = APIRouter(prefix="/food-hygiene-license", tags=["Food Hygiene License Service"])

@router.get("/list", response_model=Dict[str, Any])
async def list_food_hygiene_license_service_records(
    ...
    for i in range(1, limit + 1):
        ...
        items.append({
            ...
            "module": "food_hygiene_license_service",
...
async def process_food_hygiene_license_service_action(payload: Dict[str, Any]):
...
async def get_food_hygiene_license_service_audit_trail(record_id: str):
    return {
        "record_id": record_id,
        "module": "food_hygiene_license_service",
