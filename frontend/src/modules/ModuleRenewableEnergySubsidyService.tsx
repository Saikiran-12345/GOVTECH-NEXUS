...
export const ModuleRenewableEnergySubsidyService: React.FC = () => {
  return (
    <div className="page-content">
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '1.75rem', fontWeight: 700 }}>RenewableEnergySubsidyService</h1>
        <p style={{ color: '#64748b' }}>Solar rooftop installation inspection and subsidy credit</p>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
              ...
              <td style={{ padding: '0.75rem' }}>renewable_energy_subsidy</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
              <td style={{ padding: '0.75rem', fontWeight: 500 }}>Service Scope</td>
              <td style={{ padding: '0.75rem' }}>Solar rooftop installation inspection and subsidy credit</td>
            </tr>
          </tbody>
        </table>
      </div>
...
// Deep Enterprise UI Extensions for ModuleRenewableEnergySubsidyService.tsx
export const ModuleRenewableEnergySubsidyServiceAnalyticsWidget: React.FC = () => {
  return (
