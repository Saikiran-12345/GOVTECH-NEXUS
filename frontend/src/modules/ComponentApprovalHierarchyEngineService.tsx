...
export const ComponentApprovalHierarchyEngineService: React.FC = () => {
  return (
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
              ...
              <td style={{ padding: '0.75rem' }}>approval_hierarchy_engine_service</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
...
// Deep Enterprise UI Extensions for ComponentApprovalHierarchyEngineService.tsx
export const ApprovalHierarchyEngineServiceAnalyticsWidget: React.FC = () => {
  return (
